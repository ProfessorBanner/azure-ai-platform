...
#
# Every environment root (sandbox/dev/stg/prod) exposes this SAME interface with
# identical names and semantics, all sourced from modules/resources (never
# hard-coded physical Azure names). Phase 8 consumes infrastructure through these
# outputs without knowing Azure naming conventions.
